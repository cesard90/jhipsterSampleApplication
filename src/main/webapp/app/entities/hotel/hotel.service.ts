...
export class HotelService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/hotels';
    ...
    search(req?: any): Observable<HttpResponse<Hotel[]>> {
        const options = createRequestOption(req);
        return this.http.get<Hotel[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Hotel[]>) => this.convertArrayResponse(res));
    }
